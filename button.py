...
class Button:
    ...
    def but_custom_task(self, app, pr, terminal):
    ...
    def but_main_ports(self, app, ip, port, pr, colors):
    ...
    def check_all_but(self, app, ip, port, pr, colors, terminal):
        """ Проверка всех кнопок """
        self.but_all_info(app, pr)
        self.but_custom_task(app, pr, terminal)
        self.but_ip(ip, pr, terminal)
        self.but_main_ports(app, ip, port, pr, colors)
