...
class Button:
    ...
    def but_all_info(self, pr, task, language, settings, terminal):
        ...
        if pr.gui_button(
            ...
            terminal.page = 0
            task.task = 'all_info'
        pr.draw_rectangle_rounded(pr.Rectangle(350, 100, settings.get_button_gradient_width(), \
                                               settings.get_button_gradient_height()), \
                                                0.5, 5, colors.DARKGREEN)
    ...
    def but_custom_task(self, pr, terminal, task, language, settings):
        ...
        if pr.gui_button(
            ...
            task.task = "ip_ports"
            task.status = "WAIT"
        pr.draw_rectangle_rounded(pr.Rectangle(50, 200, settings.get_button_gradient_width(), \
                                               settings.get_button_gradient_height()), \
                                                0.5, 5, colors.DARKBYZAN)
    ...
    def but_all_ports(self, pr, task, language, settings, terminal):
        ...
        pr.draw_rectangle_rounded(pr.Rectangle(200, 100, settings.get_button_gradient_width(), \
                                               settings.get_button_gradient_height()), \
                                                0.5, 5, colors.DARKPURPLE)
    ...
    def but_ip(self, ip, pr, terminal, app, task, language, settings):
        ...
        pr.draw_rectangle_rounded(pr.Rectangle(50, 100, settings.get_button_gradient_width(), \
                                               settings.get_button_gradient_height()), \
                                                0.5, 5, colors.DARKRED)
    ...
    def but_clear(self, pr, terminal, language):
        """ Отрисовка и обработка кнопки очистки терминала """
        if pr.gui_button(
    ...
    def but_settings(self, pr, language, settings):
        """ Отрисовка и обработка кнопки включения настроек """
        if pr.gui_button(
                    pr.Rectangle(278, 528, 55, 25), ""):
            settings.settings_window(pr, language, self)
    ...
    def but_about(self, pr, terminal, language, settings):
        """ Отрисовка и обработка кнопки о программе """
        if pr.gui_button(
    ...
    def but_ping(self, pr, terminal, language, task, settings):
        ...
        pr.draw_rectangle_rounded(pr.Rectangle(200, 200, settings.get_button_gradient_width(), \
                                               settings.get_button_gradient_height()), \
                                                0.5, 5, colors.DARKORANGE)
    ...
    def but_terminal(self, pr, terminal, language, task, settings):
        ...
        pr.draw_rectangle_rounded(pr.Rectangle(350, 200, settings.get_button_gradient_width(), \
                                               settings.get_button_gradient_height()), \
                                                0.5, 5, colors.DARKAQUA)
    ...
    def but_active_devices(self, pr, terminal, language, task, settings):
        ...
        pr.draw_rectangle_rounded(pr.Rectangle(50, 300, settings.get_button_gradient_width(), \
                                               settings.get_button_gradient_height()), \
                                                0.5, 5, colors.DARKGREENORANGE)
    ...
    def settings_exit(self, pr, settings, language):
    ...
    def settings_log(self, pr, settings, language):
        ...
        pr.draw_rectangle_rounded(pr.Rectangle(397, 127, 66, 35), \
                                  0.5, 5, settings.get_button_color("log_0"))
        pr.draw_rectangle_rounded(pr.Rectangle(497, 127, 66, 35), \
                                  0.5, 5, settings.get_button_color("log_1"))
        pr.draw_rectangle_rounded(pr.Rectangle(397, 167, 66, 35), \
                                  0.5, 5, settings.get_button_color("log_2"))
        pr.draw_rectangle_rounded(pr.Rectangle(497, 167, 66, 35), \
                                  0.5, 5, settings.get_button_color("log_3"))
        pr.draw_rectangle_rounded(pr.Rectangle(397, 207, 66, 35), \
                                  0.5, 5, settings.get_button_color("log_4"))
        pr.draw_rectangle_rounded(pr.Rectangle(497, 207, 66, 35), \
                                  0.5, 5, settings.get_button_color("log_5"))
        pr.draw_rectangle_rounded(pr.Rectangle(397, 247, 66, 35), \
                                  0.5, 5, settings.get_button_color("log_6"))
    ...
    def settings_font_size(self, pr, settings, language):
        ...
        pr.draw_rectangle_rounded(pr.Rectangle(117, 147, 66, 35), \
                                  0.5, 5, settings.get_button_color("fs_s"))
        pr.draw_rectangle_rounded(pr.Rectangle(117, 197, 66, 35), \
                                  0.5, 5, settings.get_button_color("fs_m"))
        pr.draw_rectangle_rounded(pr.Rectangle(117, 247, 66, 35), \
                                  0.5, 5, settings.get_button_color("fs_b"))
    ...
    def settings_button_font_size(self, pr, settings, language):
        ...
        pr.draw_rectangle_rounded(pr.Rectangle(117, 372, 66, 35), \
                                  0.5, 5, settings.get_button_color("bfs_s"))
        pr.draw_rectangle_rounded(pr.Rectangle(117, 422, 66, 35), \
                                  0.5, 5, settings.get_button_color("bfs_m"))
        pr.draw_rectangle_rounded(pr.Rectangle(117, 472, 66, 35), \
                                  0.5, 5, settings.get_button_color("bfs_b"))
        pr.draw_text_ex(language.font, language.get_text_tr('Small'), \
    ...
    def settings_but_size(self, pr, settings, language):
        ...
        pr.draw_rectangle_rounded(pr.Rectangle(447, 372, 66, 35), \
                                  0.5, 5, settings.get_button_color("bs_s"))
        pr.draw_rectangle_rounded(pr.Rectangle(447, 422, 66, 35), \
                                  0.5, 5, settings.get_button_color("bs_m"))
        pr.draw_rectangle_rounded(pr.Rectangle(447, 472, 66, 35), \
                                  0.5, 5, settings.get_button_color("bs_b"))
        pr.draw_text_ex(language.font, language.get_text_tr('Small'), \
    ...
    def check_buttons_settings(self, pr, language, settings):
        """ Проверка и отрисовка кнопок в настройках"""
        self.settings_exit(pr, settings, language)
